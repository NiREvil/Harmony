...
محتویات فایل کد نرمال
[کد فشرده‌ی وورکر](_worker.js).

و یا کد فشرده شده (مبهم نه)  
[index.js](./_worker.js)

را کپی کرده و به طور کامل جایگزین کدهای موجود در ویرایش‌گر کلادفلر کنید.  
...
نام میزبان در پارامتر "host" هر گروه (خطوط ۵۵، ۶۹، ۸۳)
* - SNI در پارامتر "sni" هر گروه (خطوط ۵۶، ۷۰، ۸۴)
* ۴. این worker را مستقر کنید و از URL worker به عنوان لینک اشتراک خود استفاده کنید.
* ۵. هر بار که در کلاینت خود روی "Update" کلیک می‌کنید، IP های تمیز و تازه به طور خودکار تزریق می‌شوند.


### ویرایش Hostname & SNI

در این مرحله از ویرایش کد، باید `3` مرتبه `hostname` پیش‌فرض را در سه دسته جای‌گذاری کنید. 
...
5. قطعه کد پیش‌فرض در صفحه ویرایش‌گر را به طور کامل حذف کرده و کد خود را به‌طور کامل در آن جایگذاری کنید و سپس برای اعمال تغییرات از گوشه سمت راست روی گزینه آبی رنگ `Deploy` کلیک کنید.
